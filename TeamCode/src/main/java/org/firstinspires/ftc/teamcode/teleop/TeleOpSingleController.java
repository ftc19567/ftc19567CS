...
@TeleOp
public class TeleOpSingleController extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad1.a && !liftArmUp && timerUpB == false && timerUpFB == false) {
            ...
            } }else if (!gamepad1.a) {liftArmUp = false;}
        ...
        if (gamepad1.b && !liftArmDown && timerDownB == false) {
            if (arm.highGetPosition() > 1000) {
                turnServo.setPosition(1);
                arm.setPosition(1, 5);
                liftArmDown = true;
                timerDownB = true;
                timerDown.reset();
            }} else if (!gamepad1.b) {liftArmDown = false;}
